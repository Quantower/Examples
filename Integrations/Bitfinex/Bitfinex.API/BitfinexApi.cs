...
namespace Bitfinex.API
{
    public class BitfinexApi : IDisposable
    {
            ...
            :this(cancellation)
        {
            ...
            this.PrivateRestApiV2 = RestService.For<IBitfinexPrivateRestApiV2>(new HttpClient(new BitfinexPrivateHttpRequestHandler(apiKey, apiSecret))
            {
            ...
            this.PrivateWebSocketApi = new BitfinexPrivateWebSocketApi("wss://api.bitfinex.com/ws/2");
        ...
        private class BitfinexPrivateHttpRequestHandler : HttpClientHandler
        {
            ...
            public BitfinexPrivateHttpRequestHandler(string apiKey, string apiSecret)
            {
                this.apiKey = apiKey;
            ...
            {
                long nonce = BitfinexAuthHelper.GenerateNonce();
